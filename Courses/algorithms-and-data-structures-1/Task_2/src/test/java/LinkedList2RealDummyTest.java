...
public class LinkedList2RealDummyTest
{
    @Test
    public void findTestFindThatExistInMiddle()
    {
        ...
        LinkedList2RealDummy list = new LinkedList2RealDummy();
        ...
        Assert.assertEquals(true, list.head.is_dummy());
        Assert.assertEquals(true, list.tail.is_dummy());
    }
